"""Load OA-IQL params and roll out one episode; save GIF."""
import argparse
import os
import sys
import numpy as np
...
from iql_teams_oa import RNNQOppNetwork, ScannedRNN, split_teams
...
def main():
    ...
    p.add_argument("--out", default="plots/rollout_oa.gif")
    args = p.parse_args()
    ...
    for step in range(args.steps):
        ...
        for t in teams:
            ...
            new_hs, q, _ = jax.vmap(nets[t].apply, in_axes=(None, 0, 0, 0))(
